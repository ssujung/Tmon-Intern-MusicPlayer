...
public class SearchedPlayFragment extends Fragment
        implements View.OnClickListener, OnBackPressedListener, MediaController.MediaPlayerControl {

    private static final String TAG = SearchedPlayFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // slidingPaneLayout
        slidingPaneLayout = (SlidingUpPanelLayout) getActivity().findViewById(R.id.search_sliding_layout);
            ...
            public void onPanelStateChanged(View panel, SlidingUpPanelLayout.PanelState previousState, SlidingUpPanelLayout.PanelState newState) {
                if (newState.equals(SlidingUpPanelLayout.PanelState.EXPANDED)) {
                    ...
                    if (getActivity().getSupportFragmentManager().getBackStackEntryCount() != 0) {
                        ...
                        getActivity().getSupportFragmentManager().popBackStack("SEARCHED_PLAYLIST_FRAGMENT", FragmentManager.POP_BACK_STACK_INCLUSIVE);
    ...
    public void showDeleteDialog(final MusicItemDTO musicItemDTO) {
        final String title = musicItemDTO.getMusicTitle();
        final long musicId = musicItemDTO.getMusicId();
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.play_stop_btn) {
            ...
            if (v.getId() == R.id.play_option_btn) {
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == R.id.delete_from_playlist) {
                            ...
                            MusicItemDTO musicItemDTO = getMusicItem();
                            long musicId = musicItemDTO.getMusicId();
                            ...
                            final MusicItemDTO musicItemDTO = getMusicItem();     // 현재 재생목록에 있으면서 재생중인 곡
                            if (musicItemDTO != null) {

                                showDeleteDialog(musicItemDTO);
    ...
    private MusicItemDTO getMusicItem() {
        RealmQuery<MusicItemDTO> query = realm.where(MusicItemDTO.class);
        MusicItemDTO musicItem = query.equalTo("index", activeIndex).findFirst();
        Log.i(TAG, "music item : " + musicItem);
        if (musicItem != null) {
            return musicItem;
        } else {
            Log.e(TAG, "no Play Item");
            return null;
        }
    }
    ...
    private void setPlayUI(int playState) {
    ...
    public int getDuration() {
        if(player!=null && serviceBound && player.musicIsPlaying())
            return player.getMusicDuration();
        else return (int)player.getActiveMusicItem().getDuration();
    }
